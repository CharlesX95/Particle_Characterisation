# -*- coding: utf-8 -*-
"""
Created on Mon Nov 18 12:42:39 2024
...
def plot_ftir(folder_path, output_folder="raman_plots", lineweight=2, minor_ticks=5):
    """
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith('.csv'):
            ...
            plt.show()
            # Save the plot
            output_path = os.path.join(output_folder, f"raman_{title}.png")
...
# Example usage
folder_path = "./raman_data"  # Replace with your folder path
